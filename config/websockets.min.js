...
e=wsMessages[s],websocket.send(JSON.stringify(e)),log&&(log.innerHTML+="<p style='color: green;'>> WS publish: "+JSON.stringify(e)+"</p>"),"learn"!==e._command&&wsDeQueue(e)}catch(e){console.log(e)}clearTimeout(wsMessagesTimer),wsMessagesTimer=setTimeout(wsSend,1e3)}function wsDeQueue(e){var s

...
return{line:o,pos:n}},tagContent:function(e,t){for(var n=ws_data,i=0,s="",a=0;a<e.length;a++){if(n instanceof Array&&(n=n[t[i]],s+=t[i],s+=".",i++),s+=e[a],s+=".",void 0===n||void 0===n[e[a]])return s.endsWith("_path.")?s.split("_path.")[0]:"(XXXX)"
n=n[e[a]]}return n},requestData:function(){var e={_subject:"hosts/_all",_command:"learn_all"}
wsQueueSend(e)},saveChanges:function(){console.log("Loader.saveChanges()")
for(var e=document.getElementsByClassName("monitor_changes"),t=0;t<e.length;t++){var n=e[t].name
